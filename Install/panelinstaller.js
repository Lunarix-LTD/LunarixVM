...
process.title = "LunarixVM Installer"
...
if(ify(await question("Do you want the LunarixVM to have its own Ddos protection Y/N recommended(Y):","Y"))){
...
json.panelinfo.name = await question("Do you want to set panel name:","LunarixVM")
